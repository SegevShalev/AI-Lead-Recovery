...
const knowledgeIndexClient = createHttpKnowledgeIndexClient(env.AI_SERVICE_URL);
...
const app = createApp({ queue, cache: cacheRedis, suggestionClient, knowledgeIndexClient });
app.listen(port, () => {
